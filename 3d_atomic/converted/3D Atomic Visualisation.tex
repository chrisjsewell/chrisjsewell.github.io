...
\begin{figure}[H]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight},height=0.3\paperheight}{3D Atomic Visualisation_files/output_63_0.pdf}\end{center}\caption{an example of a 2D representation of the atomic data}\label{fig:mpl1}
    \end{figure}
