...
\begin{figure}[H]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight},height=0.2\paperheight}{3D Atomic Visualisation_files/output_62_0.pdf}\end{center}\caption{an example of an 2D scatter plot (with depth perception)}\label{fig:mplplot1}
    \end{figure}
...
\begin{figure}[H]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight},height=0.2\paperheight}{3D Atomic Visualisation_files/output_67_0.jpeg}\end{center}\caption{an example of nearest-neighbour polygons}\label{fig:nnpolygons}
    \end{figure}
